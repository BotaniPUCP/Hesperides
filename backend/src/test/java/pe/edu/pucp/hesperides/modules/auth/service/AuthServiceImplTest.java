...
import pe.edu.pucp.hesperides.modules.users.service.UserResponseMapper;
...
class AuthServiceImplTest {
    ...
    @BeforeEach
    void setUp() {
        UserResponseMapper mapper = new UserResponseMapper(teamMembersRepository);
        ...
        service = new AuthServiceImpl(usersRepository, passwordEncoder, tokenProvider,
                refreshTokenService, loginAttemptService, mapper);
    }
