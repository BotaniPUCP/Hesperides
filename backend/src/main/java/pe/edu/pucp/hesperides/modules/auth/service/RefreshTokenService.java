...
public class RefreshTokenService {
    ...
    private static final String GENERIC_FAILURE = "Invalid or expired token";
     ...
     * la necesita para encadenar replaced_by_id sin volver a buscar por hash,
     * que dependería de que Hibernate ya hubiera hecho flush.
     */
